...
public class RegistrationSteps {
    ...
    public void enterValidDetails() {
        ...
        driver.findElement(By.id("member_emailaddress")).sendKeys("abcdefgqd@example.com");
        driver.findElement(By.id("member_confirmemailaddress")).sendKeys("abcdefgqd@example.com");
